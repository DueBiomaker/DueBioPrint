...
namespace BioMaker.model
{
    internal class Coordinate
    {
        ...
        private const int area_size = 120; // 80
        private const int margin = 16;
        private const int label_font_size = 16;
        private readonly Vector4 z_unit = new Vector4(0.0f, 0.0f, area_size, 0.0f);

        private readonly int[] coordinate_colors =
        {
        ...
        private readonly OpenTK.Graphics.Color4[] label_colors =
        {
        ...
        private readonly string[] names = { "data/ArrowX.stl", "data/ArrowY.stl", "data/ArrowZ.stl" };

        #endregion defines

        private Submesh[] submesh = null;
        private TopoModel[] model = null;
        //QFont font;
        //float arrow_length;
